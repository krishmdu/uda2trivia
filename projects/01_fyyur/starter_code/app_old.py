...
class Venue(db.Model):
    ...
    Seeking_talent_desc = db.Column(db.String)
...
class Artist(db.Model):
    ...
    Seeking_venue_desc = db.Column(db.String)
...
def venues_old():
  ...
  return render_template('pages/venues_old.html', areas=data);
...
def venues():
  # TODO: replace with real venues data.
  #       num_upcoming_shows should be aggregated based on number of upcoming shows per venue.
  # data = db.session.query(Venue.city, func.count(Venue.city)).group_by(Venue.city).all()
